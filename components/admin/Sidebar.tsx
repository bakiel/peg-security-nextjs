...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="fixed top-0 left-0 z-40 h-screen w-[280px] hidden lg:block">
        <div className="h-full flex flex-col bg-gradient-to-br from-onyx via-onyx-light to-onyx border-r border-gold/20">
          {/* Logo Section */}
          <div className="flex items-center gap-3 px-6 py-6 border-b border-gold/10">
      ...
      {/* Mobile Sidebar Trigger (handled by Header component) */}
    </>
  )
}
