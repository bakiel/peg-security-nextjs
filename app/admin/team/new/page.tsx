  ...
  const onSubmit = async (data: TeamMemberFormData) => {
    ...
    try {
      ...
      const teamMemberData = {
        ...
        photo_public_id: uploadResult.path,
      ...
      if (!response.ok) {
        ...
        throw new Error(error.details || 'Failed to create team member')
      }
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-sans font-bold text-onyx mb-2">Add Team Member</h1>
        <p className="text-grey-medium font-sans">Create a new team member profile</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FileUpload
            ...
            error={photoError}
            helperText="Upload a professional headshot photo (max 5MB)"
          />
